...
import { FaFacebook, FaHeart, FaEdit, FaTrash } from "react-icons/fa";
    ...
    <main className="flex-1 p-6 bg-gray-100">
      ...
      <section className="mb-8">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600">Summary of your recent social media posts.</p>
        </div>
      ...
      <section className="grid md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600">Summary of engagement metrics over time.</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600">Summary of your audience composition.</p>
          <div className="mt-4 h-64">
